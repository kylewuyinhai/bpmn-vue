...
// import customTranslate from "../customtranslate/customTranslate"; //汉化引入
import { xmlStr } from "../mock/HelloWorld";
import customModule  from "./components/customModeler/custom"
export default {
  name: '',
  components: {},
